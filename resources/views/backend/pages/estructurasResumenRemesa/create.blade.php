...
@section('title')
Crear Estructura Resumen Remesa - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Crear Estructura Resumen Remesa</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.estructurasResumenRemesa.index') }}">Todas las Estructuras Resumen Remesa</a></li>
                    <li><span>Crear Estructura Resumen Remesa</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Crear Estructura Resumen Remesa</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.estructurasResumenRemesa.store') }}" method="POST">
                        @csrf
                        <div class="form-row">
