...
@section('title')
Crear Tipo Formato - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Crear Tipo Formato</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.tiposFormato.index') }}">Todas los Tipos Formatos</a></li>
                    <li><span>Crear Tipo Formato</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Crear Nuevo Tipo Formato</h4>
                    @include('backend.layouts.partials.messages')
                    
                    <form action="{{ route('admin.tiposFormato.store') }}" method="POST">
                        @csrf
                        <div class="form-row">
